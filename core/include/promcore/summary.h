...
#include "promcore/detail/ckms_quantiles.h"
#include "promcore/detail/core_export.h"
#include "promcore/detail/time_window_quantiles.h"
...
/// a data race.
class PROMCORE_CPP_CORE_EXPORT Summary {
 public:
...
/// Register(Registry&).
PROMCORE_CPP_CORE_EXPORT detail::Builder<Summary> BuildSummary();
