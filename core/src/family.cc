...
#include "promcore/check_names.h"
...
template class PROMCORE_CPP_CORE_EXPORT Family<CounterDouble>;
template class PROMCORE_CPP_CORE_EXPORT Family<CounterInt>;
template class PROMCORE_CPP_CORE_EXPORT Family<GaugeDouble>;
template class PROMCORE_CPP_CORE_EXPORT Family<GaugeInt>;
template class PROMCORE_CPP_CORE_EXPORT Family<Histogram>;
template class PROMCORE_CPP_CORE_EXPORT Family<Info>;
template class PROMCORE_CPP_CORE_EXPORT Family<Summary>;
